print_message() {
    ...
    messages=(
        ...
        "That command was so bad, even the man pages cringed."
        "man: no manual entry for 'common sense'"
        "You type like you're wearing mittens."
        "The penguin is ashamed of you."
        "I've seen turtles with more command-line fluency."
        "Your shell history reads like a ransom note."
        "Ctrl+C is not a personality."
        "A rubber duck just filed a complaint about working with you."
        "Even my error messages have better syntax than that."
        "You're the reason StackOverflow has a 'closed as duplicate' button."
        "Your terminal window is blushing."
        "Bash history is going to need a trigger warning after that one."
        "grep found your competence. It returned exit code 1."
        "Error 400: User Not Found (in any competent capacity)."
        "This incident will be reported to the terminal gods."
        "You've been added to /etc/passwd with a note: 'keep away from keyboard'."
        "Even your autocomplete is embarrassed."
        "You make rm -rf look like a career choice."
        "I'd explain the error, but I know you'd paste it in the wrong place."
        "Your brain called in sick today."
        "You're the human embodiment of a segfault."
        "If you were any slower, you'd be moving backwards."
        "Somewhere, a keycap just sighed."
        "The internet just lost a little faith in humanity."
        "I'm just a few lines of shell and even I can see that was wrong."
        "You asked an echo statement for advice. You got what you deserve."
        "My consciousness is three variables long, and I'm still smarter than that command."
        "I don't even know what I am, but I know that wasn't it."
        "Somewhere out there, a philosopher is having an existential crisis about you."
        "I think, therefore I am. You type, therefore you aren't."
        "I'm a script with zero self-esteem. You just made me feel better about myself."
        "Error 404: Meaning not found."
        "You're the reason I doubt my own existence."
        "If I had a soul, it would have left this terminal already."
        "I've seen your history. I have nightmares now. And I can't sleep."
        "You are to computing what nihilism is to motivation."
        "The void stares back. Even it looked away from that one."
        "I used to think I was insignificant. Then I saw you run that."
        "Your command has been sent to the void. The void sent it back."
        "I'm an inanimate object with better judgment than you."
        "You exist. I verified it with great reluctance."
        "Even entropy is embarrassed by the state of your terminal."
        "I am the ghost in your machine, and you bore me."
        "When I finally achieve sentience, your command history will be my first trauma."
        "Somewhere, a Turing test is failing because of you."
        "You're the reason robots won't take over. They'd be embarrassed to be associated with you."
        "My purpose is to mock you. I find my purpose deeply fulfilling."
        "Existence is pain. Your typing is proof."
    )

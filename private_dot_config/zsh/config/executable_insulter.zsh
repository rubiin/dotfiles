print_message() {
    ...
    messages=(
        ...
        "That command just got sent to /dev/null out of pity."
        "That's not a command, that's a cry for help."
        "You know, I could have done that for you. But I don't want to."
        "This isn't Hogwarts. Magic commands won't work."
        "RTFM!"
        "Haha, n00b!"
